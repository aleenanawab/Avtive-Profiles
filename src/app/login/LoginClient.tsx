...
export default function LoginClient() {
  ...
  const desktopView = (
    <div className="w-full max-w-4xl mx-auto my-auto py-6 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
      ...
      {/* Left Column: Brand & Return Highlights (Desktop only) */}
      <div className="hidden lg:block lg:col-span-5 space-y-6 text-left">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-cyan-500 to-blue-600 flex items-center justify-center font-extrabold text-white text-xl shadow-md shadow-black/30">
              A
            </div>
        ...
        <div className="space-y-3 pt-2">
          <div className="flex items-start gap-3">
            <div className="w-5 h-5 rounded-full bg-cyan-500/15 text-cyan-400 flex items-center justify-center shrink-0 mt-0.5 border border-cyan-500/25">
          ...
          <div className="flex items-start gap-3">
            <div className="w-5 h-5 rounded-full bg-emerald-500/15 text-emerald-400 flex items-center justify-center shrink-0 mt-0.5 border border-emerald-500/25">
      ...
      {/* Right Column: Desktop Sign-in / Forgot Password Form */}
      <div className="w-full max-w-[440px] mx-auto lg:col-span-7">
            ...
            <div className="space-y-5">
              ...
              <form onSubmit={handleSendResetLink} className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-[#070D18] border border-white/10 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500/50 transition-all"
                    />
                ...
                <button
                  ...
                  className="w-full py-3 px-6 rounded-xl font-bold text-sm bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white shadow-md shadow-black/30 transition-all cursor-pointer disabled:opacity-50 flex items-center justify-center gap-2"
                >
                  {isSendingReset ? (
                    <>
              ...
              <div className="pt-1 text-center">
                ...
                >
                  Remember your password? <span className="text-cyan-400 font-semibold hover:underline">Sign In</span>
                </button>
              </div>
            </div>
          ) : (
  ...
  const mobileView = (
    <div className="w-full flex-1 flex flex-col justify-between py-2 text-left">
      ...
      <div>
        ...
        {showForgotPassword ? (
          ...
          <div className="space-y-4">
            ...
            {forgotSuccessMessage && (
              <div className="p-2.5 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs space-y-1.5">
                <div className="flex items-center gap-2">
            ...
            <form onSubmit={handleSendResetLink} className="space-y-3">
              <div className="space-y-1">
                <label className="text-[11px] font-medium text-slate-300 ml-1">Email Address</label>
                <div className="relative">
                  <input
                    type="email"
                    required
                    ...
                    onChange={(e) => setForgotEmail(e.target.value)}
                    placeholder="e.g. aleena@example.com"
                    className="figma-input w-full pl-9 pr-3.5 py-2.5 text-xs text-white placeholder:text-slate-500 focus:outline-none focus:ring-1 focus:ring-cyan-500/50 transition-all"
                  />
              ...
              <div className="pt-1">
                <button
                  type="submit"
                  disabled={isSendingReset}
                  className="w-full py-2.5 px-4 rounded-xl font-bold text-xs bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white shadow-md shadow-black/20 transition-all cursor-pointer disabled:opacity-50 flex items-center justify-center gap-2"
                >
                  {isSendingReset ? (
                    <>
            ...
            <div className="pt-2 text-center">
              ...
              >
                Back to <span className="text-cyan-400 font-semibold hover:underline">Sign In</span>
              </button>
            </div>
          </div>
        ) : (
          ...
          <>
            ...
            <form onSubmit={handleLogin} className="space-y-3">
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) => setEmail(e.target.value)}
                  placeholder="e.g. aleena@example.com"
                  className="figma-input w-full px-3.5 py-2.5 text-xs text-white placeholder:text-slate-500 focus:outline-none focus:ring-1 focus:ring-cyan-500/50 transition-all"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => setPassword(e.target.value)}
                    placeholder="••••••••"
                    className="figma-input w-full pl-3.5 pr-10 py-2.5 text-xs text-white placeholder:text-slate-500 focus:outline-none focus:ring-1 focus:ring-cyan-500/50 transition-all"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full py-3 px-5 rounded-xl font-bold text-xs bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white shadow-md shadow-black/20 transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                >
                  {isLoading ? (
                    <>
                      <Loader2 className="w-3.5 h-3.5 animate-spin" />
            ...
            <div className="relative flex items-center justify-center my-3">
              <div className="border-t border-white/10 w-full" />
              <span className="bg-[#050913] px-2 text-[10px] text-slate-500 uppercase tracking-wider font-mono">or</span>
            </div>
            ...
            <button
              ...
              onClick={handleGoogleSignIn}
              disabled={isLoading}
              className="w-full py-2.5 px-4 rounded-xl text-xs font-medium bg-white/5 hover:bg-white/10 border border-white/10 text-slate-200 flex items-center justify-center gap-2 transition-all cursor-pointer disabled:opacity-50"
            >
      ...
      <div className="pt-4 pb-1 text-center text-[11px] text-slate-400">
        ...
        <Link href="/register" className="font-bold text-cyan-400 hover:text-cyan-300 hover:underline ml-1">
          Sign up
        </Link>
      </div>
